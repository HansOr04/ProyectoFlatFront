...
const DetailsFlatPage = () => {
  ...
  const showAmenities =
    flat?.amenities &&
    Object.keys(flat.amenities).some((key) => flat.amenities[key]);
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12}>
          <Grid container spacing={2}>
            <Grid item xs={12}>
              {showMainImage ? (
                <MainImage src={mainImageUrl} alt={flat.title} />
              ) : (
                <Box
                  sx={{
                    height: 400,
                    ...
                    <Box sx={{ mb: 3 }}>
                      ...
                      {flat.houseRules?.additionalRules?.length > 0 && (
                        <Box sx={{ mt: 2 }}>
                          ...
                          <List dense>
                            {flat.houseRules.additionalRules.map(
                              (rule, index) => (
                                <ListItem key={index}>
                                  <ListItemIcon>
                                    <CheckIcon
            ...
            {selectedTab === 1 && showLocation && (
              <Box>
                ...
                <List>
                  ...
                  {flat.location?.coordinates?.lat &&
                    flat.location?.coordinates?.lng && (
                      <ListItem>
                        <ListItemIcon>
                          <LocationOnIcon sx={{ color: PRIMARY_COLOR }} />
                        </ListItemIcon>
                ...
                <List dense>
                  ...
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={`${
                        flat.availability?.maximumStay || 365
                      } days`}
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={`${
                        flat.availability?.advanceNotice || 1
                      } days`}
                    />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={
                        flat.availability?.instantBooking
                          ? "Available"
                          : "Not available"
                      }
                    />
...
>>>>>>> 0c0c1770f154baf9f40ed42623d9dd316e6ca1a5
        ...
        <DialogContent>
          <Box sx={{ pt: 2 }}>
            ...
            <Grid container spacing={2} sx={{ mb: 2 }}>
              {Object.entries(newReview.rating.aspects).map(
                ([aspect, value]) => (
